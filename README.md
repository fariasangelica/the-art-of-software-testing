...
>
> "Impactos de baixo nível dos bugs podem apenas incomodar o usuário final, os piores impactos podem resultar em grandes perdas financeiras ou mesmo causar danos às pessoas."
>
> "O teste de software é um processo, ou uma série de processos, projetado para garantir que p código faça o que foi projetado para fazer e, inversamente, que não faça nada não intencional."
>
